    ...
    try {
        ...
        if (response != null) {
            ...
            if (status == 200) {
                ...
                System.out.println("\t\t\t\t\tErreur lors de la mis Ã  jour du produit : " + status);
            }
            response.close(); 
        }
    } catch (Exception e) {
...
public static void displayTableHeader() {
    System.out.println("\t┌────────────┬─────────────────────┬────────┬──────────────┬──────────────┐");
    System.out.println("\t│ Code       │ Designation         │ Prix   │ Quantité     │ Catégorie    │");
    System.out.println("\t╞════════════╪═════════════════════╪════════╪══════════════╪══════════════╡");
}

public static void displayProduct(int code, String designation, float prix, int qte, int id_category) {
    System.out.printf("\t│ %-10d │ %-20s │ %-6.2f │ %-12d │ %-12d │%n", code, designation, prix, qte, id_category);
    System.out.println("\t├────────────┼─────────────────────┼────────┼──────────────┼──────────────┤");
}
